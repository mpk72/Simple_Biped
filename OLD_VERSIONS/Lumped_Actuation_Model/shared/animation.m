...
plot(F1(1),F1(2),[Color_1 '.'],'MarkerSize',PtMass_MarkerSize*P.parameters.m1^(1/3));
plot(F2(1),F2(2),[Color_2 '.'],'MarkerSize',PtMass_MarkerSize*P.parameters.m2^(1/3));
plot(Hip(1),Hip(2),[Color_Hip '.'],'MarkerSize',PtMass_MarkerSize*P.parameters.M^(1/3));
