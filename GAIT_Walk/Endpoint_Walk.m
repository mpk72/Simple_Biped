...
output.eventgroup(2).event = [...
    (END_S(1) - START_D(1)) - input.auxdata.goal.Step_Vector(1),...
    (END_S(2) - START_D(2)) - input.auxdata.goal.Step_Vector(2),...
    END_S(3) - START_D(3),...
    END_S(4) - START_D(4)];

%%%% Enforce step vector for swing foot
output.eventgroup(3).event = [...
    Position.footTwo.x(1) + input.auxdata.goal.Step_Vector(1),...
    Position.footTwo.x(2) - input.auxdata.goal.Step_Vector(1),...
    Position.footTwo.y(1) + input.auxdata.goal.Step_Vector(2),...
    Position.footTwo.y(2) - input.auxdata.goal.Step_Vector(2)];
